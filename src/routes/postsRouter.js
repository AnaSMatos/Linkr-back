...
import {getPosts, getUserPosts, postPost, deletePost, updatePost, getNewPosts, repost, getRepost} from "../controllers/postsController.js";
...
postsRouter.get("/repost/:id", getRepost)
